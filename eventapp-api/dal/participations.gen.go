...
func newParticipation(db *gorm.DB, opts ...gen.DOOption) participation {
	...
	_participation.ID = field.NewField(tableName, "id")
	...
	_participation.FirstName = field.NewString(tableName, "first_name")
	_participation.LastName = field.NewString(tableName, "last_name")
	_participation.Email = field.NewString(tableName, "email")
	_participation.AdminCode = field.NewString(tableName, "admin_code")
	_participation.EventID = field.NewField(tableName, "event_id")
...
func (p *participation) updateTableName(table string) *participation {
	...
	p.AdminCode = field.NewString(table, "admin_code")
	p.EventID = field.NewField(table, "event_id")
...
func (p *participation) fillFieldMap() {
	...
	p.fieldMap["admin_code"] = p.AdminCode
